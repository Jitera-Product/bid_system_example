  ...
  class QuestionsController < BaseController
    ...
    def create
      ActiveRecord::Base.transaction do
        ...
        tag_validator = TagValidator.new(question_params[:tag_ids])
        ...
        if question_validator.valid? && tag_validator.valid? && answer_validator.valid?
          ...
          raise ActiveRecord::RecordNotFound unless Tag.where(id: question_params[:tag_ids]).count == question_params[:tag_ids].size
    ...
    def question_params
      params.require(:question).permit(:question_text, tag_ids: [])
    end
